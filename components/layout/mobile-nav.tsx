...
export function MobileNav() {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent
        side="left"
        className="w-64 p-0 bg-stone-50/95 dark:bg-stone-950 border-stone-200 dark:border-stone-800"
      >
        <div className="border-b border-stone-200 px-6 py-5 dark:border-stone-800">
          ...
          <p className="mt-0.5 text-xs text-stone-500">Manning · Mestre · Belén · Echevarría</p>
        </div>
